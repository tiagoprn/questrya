...
This is an open-source app for gamers to track their backlog, log playtime, add game notes, and view detailed stats on their gaming quest.
...
- Backlog gaming tracking:
    - game information (shared between all users)
    - hours played
    - notes - things you want to remember about games
    - personal review

- "Public Profile" support, where you control what you want to share with other users (if you want to share anything)

- "spotify wrapped"-like reports:
    - all games started on a given period;
    - all games finished on a given period;


## Technical Features

The backend was bootstrapped from this cookiecutter template of mine: <https://github.com/tiagoprn/celery-db-flask-cookiecutter>.

This project provides a RESTful API for managing users, games and reports using Flask.

The API allow users to... TBD
